...
const styles = StyleSheet.create({
  ...
  filterChipRow: { marginTop: Spacing.sm, flexGrow: 0, flexShrink: 0 },
  filterChipRowContent: { gap: Spacing.sm, paddingHorizontal: Spacing.lg, paddingVertical: 4, alignItems: 'center' },
  filterChip: {
