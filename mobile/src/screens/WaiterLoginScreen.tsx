...
import { waiterLogin, saveWaiterToken, getStoredHotelId } from '../services/api';
import { Colors, FontSize, Spacing, BorderRadius, Shadows } from '../utils/constants';
import AsyncStorage from '@react-native-async-storage/async-storage';

export const WAITER_PROFILE_KEY = '@hotel_pos_waiter_profile';
...
const WaiterLoginScreen: React.FC<Props> = ({ navigation }) => {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      navigation.replace('WaiterDisplay');
    } catch (e: any) {
