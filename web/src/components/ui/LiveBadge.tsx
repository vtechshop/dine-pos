...
export function LiveBadge({ label = 'NEW', pulse = true }: LiveBadgeProps) {
  return (
    <span className="relative inline-flex items-center gap-1 rounded-full bg-blue-500 px-2 py-0.5 text-[9px] font-bold uppercase tracking-widest text-white shadow-sm">
      {pulse && (
