...
router.post('/', authMiddleware, async (req: AuthRequest, res: Response) => {
  ...
  try {
    ...
    await Product.create([
      ...
      // STARTERS
      { ...base, name: 'Chicken 65',      price: 160, category: starters._id, isVeg: false, shortCode: 'C65', description: 'Crispy spiced chicken deep-fried — Bangalore style',         image: 'https://images.unsplash.com/photo-1610057099443-fde6c99db9e1?w=400&h=300&fit=crop' },
      ...
      { ...base, name: 'Egg Puff',        price: 25,  category: snacks._id,   isVeg: false, shortCode: 'EPF', description: 'Flaky puff pastry with spiced egg filling',                  image: 'https://images.unsplash.com/photo-1608039829572-9b0080593066?w=400&h=300&fit=crop' },
      // DESSERTS
      { ...base, name: 'Gulab Jamun (2 pcs)', price: 40, category: desserts._id, isVeg: true, shortCode: 'GJ',  description: 'Soft melt-in-mouth jamuns soaked in rose syrup',          image: 'https://images.unsplash.com/photo-1666190440431-4bf10cd2277b?w=400&h=300&fit=crop' },
